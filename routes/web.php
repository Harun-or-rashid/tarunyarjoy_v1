...
Route::group(['as' => 'home.', 'prefix' => 'home', 'middleware' => ['auth', 'role:Admin|Volunteer', 'prevent-back-history']], function () {
...
Route::group(['middleware' => ['role:Donor', 'prevent-back-history']], function () {
